package nhapmon.nhom15.sbshoppingcart.dao;
...
public class ProductDAO {
    ...
    public PaginationResult<ProductInfo> queryProducts(int page, int maxResult, int maxNavigationPage, //Tìm kiếm theo tên ..
            String likeName) {
    ...
    public PaginationResult<ProductInfo> queryProductsbyCategory(int page, int maxResult, int maxNavigationPage, //Tìm kiếm theo tên ..
            String category) {
        String sql = "Select new " + ProductInfo.class.getName() //
                + "(p.code, p.name, p.price,p.description,p.category )" + " from "
                + Product.class.getName() + " p ";
    ...
    public PaginationResult<ProductInfo> queryProductsbyName(int page, int maxResult, int maxNavigationPage, String likeName) {
