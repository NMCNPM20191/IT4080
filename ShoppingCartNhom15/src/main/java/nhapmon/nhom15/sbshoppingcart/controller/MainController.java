...
import nhapmon.nhom15.sbshoppingcart.form.CustomerForm;
import nhapmon.nhom15.sbshoppingcart.model.CartInfo;
import nhapmon.nhom15.sbshoppingcart.model.CustomerInfo;
import nhapmon.nhom15.sbshoppingcart.model.ProductInfo;
import nhapmon.nhom15.sbshoppingcart.pagination.PaginationResult;
import nhapmon.nhom15.sbshoppingcart.utils.Utils;
import nhapmon.nhom15.sbshoppingcart.validator.CustomerFormValidator;
...
public class MainController {
    ...
    public String listProductHandlerbyCategory(Model model, //
            @RequestParam(value = "name", defaultValue = "") String category,
            @RequestParam(value = "page", defaultValue = "1") int page) {
        final int maxResult = 9;
        final int maxNavigationPage = 10;
 
        PaginationResult<ProductInfo> result = productDAO.queryProductsbyCategory(page, //
                maxResult, maxNavigationPage, category);
